...
export const CreateEventBody = z.object({
  ...
  // offset: true aceita tanto '2025-06-15T18:00:00Z' quanto '2025-06-15T18:00:00-03:00'
...
export const ConfirmAttendanceBody = z
  .object({
    status: z.enum(["CONFIRMED", "DECLINED"]),
    justification: z.string().min(1).max(500).optional(),
  })
  .refine((data) => data.status === "CONFIRMED" || !!data.justification, {
    message: "Justificativa obrigatória ao declinar",
    path: ["justification"],
  });
